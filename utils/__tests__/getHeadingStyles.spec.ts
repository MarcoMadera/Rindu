...
describe("getHeadingStyles", () => {
  ...
  it("should return the correct styles h3", () => {
    ...
    expect(styles.className).toStrictEqual(expect.any(String));
    expect((styles.styles.props as PropsWithChildren).children).toBe(
      "h3.__jsx-style-dynamic-selector{color:#fff;font-weight:700;font-size:1.5em;margin:0;text-align:left;-webkit-line-clamp:3;pointer-events:auto;-webkit-user-select:auto;-moz-user-select:auto;user-select:auto;padding:0;line-height:28px}@media(max-width:768px){h30 {font-size:1.3em;line-height:20px;padding:0 8px}}"
    );
  });
});
