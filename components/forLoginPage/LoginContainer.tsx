const LoginContainer: React.FC = () => {
  ...
  const scopes =
    "streaming,user-read-email,playlist-read-private,user-read-private,user-library-read,user-library-modify,user-read-playback-state,user-modify-playback-state,playlist-modify-private,playlist-modify-public";
  const paramsData = {
